/**
 * Laura AI Assistant Configuration
 * Defines tools, prompts, and behavior for the Gino's Pizza voice assistant
 */
...
/**
 * Creates the complete Laura AI configuration for OpenAI Realtime API
 * @param {Object} vadConfig - VAD configuration object
 * @returns {Object} Complete Laura configuration
 */
export function createLauraConfig(vadConfig) {
  return {
    type: 'realtime',
    model: 'gpt-realtime',
