...
export const MENU = [
  ...
  // GOURMET PIZZAS
  // =====================
  { id: 'gourmet-greek', kind: 'gourmet', name: 'Greek', details: 'Feta, Black Olives, Red Onions, Tomatoes', vegetarian: true },
  ...
  { id: 'gourmet-hawaiian', kind: 'gourmet', name: 'Hawaiian', details: 'Ham, Pineapple, Bacon Crumble' },
  { id: 'gourmet-meat-lovers', kind: 'gourmet', name: 'Meat Lovers', details: 'Pepperoni, Bacon Crumble, Ham' },
  { id: 'gourmet-mega-veggie', kind: 'gourmet', name: 'Mega Veggie', details: 'Mushrooms, Green Peppers, Tomatoes, Red Onions', vegetarian: true },
  { id: 'gourmet-grilled-chicken-club', kind: 'gourmet', name: 'Grilled Chicken Club', details: 'Chicken, Tomatoes, Red Onions' },
  { id: 'gourmet-meat-mania', kind: 'gourmet', name: 'Meat Mania', details: 'Pepperoni, Bacon Crumble, Sausage' },
  { id: 'gourmet-bacon-cheeseburger', kind: 'gourmet', name: 'Bacon Cheeseburger', details: 'Beef, Bacon Crumble, Cheddar' },
  { id: 'gourmet-chicken-shawarma', kind: 'gourmet', name: 'Chicken Shawarma', details: 'Shawarma Base, Chicken, Tomatoes, Onions' },
  { id: 'gourmet-bacon-bonanza', kind: 'gourmet', name: 'Bacon Bonanza', details: 'Bacon Crumble, Bacon Strips, Ham, Extra Cheese' },
  { id: 'gourmet-bruschetta', kind: 'gourmet', name: 'Bruschetta', details: 'Garlic Base, Bruschetta Mix, Oregano', vegetarian: true },
  { id: 'gourmet-butter-chicken', kind: 'gourmet', name: 'Butter Chicken', details: 'Butter Chicken Sauce, Chicken, Onions, Green Peppers' },
  { id: 'gourmet-chicken-bacon-alfredo', kind: 'gourmet', name: 'Chicken Bacon Alfredo', details: 'Alfredo Base, Chicken, Mushrooms, Cheddar, Bacon' },
  { id: 'gourmet-bbq-chicken-corn', kind: 'gourmet', name: 'BBQ Chicken Corn', details: 'BBQ Chicken, Corn, Red Onions' },
  { id: 'gourmet-canadian', kind: 'gourmet', name: 'Canadian', details: 'Pepperoni, Mushrooms, Bacon Crumble' },
  { id: 'gourmet-pepperoni', kind: 'gourmet', name: 'Pepperoni', details: 'Sauce, Mozzarella, Pepperoni' },
  { id: 'gourmet-vegetarian', kind: 'gourmet', name: 'Vegetarian', details: 'Mushrooms, Green Peppers, Tomatoes', vegetarian: true },
  ...
  { id: 'gourmet-shahi-paneer', kind: 'gourmet', name: 'Shahi Paneer', details: 'Shahi Sauce, Paneer, Green Peppers, Red Onions', vegetarian: true },
  { id: 'gourmet-spinach-supreme', kind: 'gourmet', name: 'Spinach Supreme', details: 'Garlic Base, Spinach, Feta, Cheddar, Red Peppers', vegetarian: true },
  { id: 'gourmet-tandoori-paneer', kind: 'gourmet', name: 'Tandoori Paneer', details: 'Tandoori Paneer, Green Peppers, Red Onions', vegetarian: true },
  { id: 'gourmet-royal', kind: 'gourmet', name: 'Royal', details: 'Pepperoni, Mushrooms, Green Peppers' },
  { id: 'gourmet-tandoori-chicken', kind: 'gourmet', name: 'Tandoori Chicken', details: 'Tandoori Chicken, Green Peppers, Red Onions' },
